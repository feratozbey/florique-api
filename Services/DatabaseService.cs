...
public class DatabaseService
{
    ...
    public async Task<List<SubscriptionInfo>> GetActiveSubscriptionsAsync()
    {
        ...
        try
        {
            ...
            var cmdText = _isSqlServer
                ? "SELECT [userId], [subscriptionstatus], [subscriptionexpiry], [subscriptiontoken], [subscriptionproductid], [subscriptionorderid], [subscriptioncreditslastgranted] FROM [users] WHERE [subscriptionstatus] IN ('active','cancelled','grace_period','pending');"
                : "SELECT userid, subscriptionstatus, subscriptionexpiry, subscriptiontoken, subscriptionproductid, subscriptionorderid, subscriptioncreditslastgranted FROM users WHERE subscriptionstatus IN ('active','cancelled','grace_period','pending');";
